...
-- 2 Exiba o nome do motoboy e a placa da moto de todos que realizaram mais de 5 entregas no �ltimo m�s.
SELECT 
...
-- 4 Liste os motoboys que n�o possuem nenhuma entrega atribu�da.
...
-- 5 Encontre o pedido de maior valor e exiba a descri��o, nome do cliente e nome do motoboy respons�vel.
...
-- 6 Mostre todos os pedidos cujo pagamento foi feito na entrega e ainda n�o foram entregues.
...
-- 7 Atualize o status para "Entregue" de todos os pedidos que est�o com status "Em Rota" h� mais de 2 dias.
UPDATE Pedido
...
-- 9 Altere o motoboy respons�vel pelo pedido de ID 2 para o motoboy ID 2.
...
-- 10 Remova todos os registros de pedidos que n�o possuem cliente vinculado.
...
-- 13 Exiba o nome do motoboy e o maior valor de pedido que ele j� entregou.
...
-- 15 Mostre todos os pedidos e, ao lado, o nome do cliente e o nome do motoboy respons�vel.
...
-- 16 Liste todos os motoboys e a data do �ltimo pedido entregue por cada um.
SELECT E.Nome, FORMAT(P.DataHoraPedido, 'dd/MM/yyyy')
FROM Entregador E
INNER JOIN Pedido P
    ON E.Id = P.IdEntregador

-- 17 Exiba todos os clientes que j� tiveram pedidos com pagamento na entrega, mostrando tamb�m o valor m�dio desses pedidos.
SELECT 
    C.Nome NomeCliente,
...
-- 18 Liste todos os motoboys e o total de pedidos que ainda est�o "Em Rota".
...
-- 19 Exiba o nome dos motoboys que n�o realizaram nenhum pedido no �ltimo m�s.
...
-- 20 Mostre todos os pedidos, o nome do cliente e o nome do motoboy, incluindo pedidos sem motoboy atribu�do.
